function to_do_list() {
  //Usinf readlineSync to take user input
...
// - exit                     Exit the application`
  ...
  while (true) {
      let command = readlineSync.question("Enter your command: ").trim().toLowerCase()

      if (command == 'add') {
          // Add a new task to the array
          let task_to_add = readlineSync.question("Enter description of the task: ")
          ...
          let index = readlineSync.question("Enter the index of the completed task: ")
          ...
          let index = Number(readlineSync.question("Enter the index of the task to remove: "))
          if (index < tasks_arr.length) {
